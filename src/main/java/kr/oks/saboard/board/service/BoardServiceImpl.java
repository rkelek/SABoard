...
public class BoardServiceImpl implements BoardService,ApplicationContextAware{
	...
	public int insertBoard(BoardDomain boardDomain) throws Exception {
		...
		System.out.println( getBoardDetailById(boardDomain.getId())+"qwe0");
		...
		System.out.println(XSSFilter.removeXSS(boardDomain.getUser_id())+"qwe1");
		System.out.println(XSSFilter.removeXSS(boardDomain.getTitle())+"qwe2");
		System.out.println(XSSFilter.removeXSS(boardDomain.getContent())+"qwe3");
		System.out.println(XSSFilter.removeXSS(boardDomain.getPassword())+"qwe4");
